...
/**
 * Base Rock, Paper, Scissors, Lizard, Spock class for game
 * @author Grace Langhorst
 */
public class RPSLSpock {
    ...
    /**
     * Method to determine if human pick is valid
     * @param pick  RPSLS choice
     * @return if human choice is valid
     */
    ...
    /**
     * Method to generate computer pick
     * @return computer pick as string
     */
    ...
    /**
     * Method to determine if computer won game
     * @param c_pick computer choice
     * @param h_pick human choice
     * @return result if computer won
     */
